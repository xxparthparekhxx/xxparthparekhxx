...
from .views import StackList, StackDetail, ProjectMediaList, ProjectMediaDetail, \
    ProjectList, ProjectDetail, PostList, PostDetail,ProjectListByStack

urlpatterns = [
    path('stacks/', StackList.as_view(), name='stacks-list'),
    path('stacks/<int:pk>/', StackDetail.as_view(), name='stacks-detail'),
    path('stacks/<int:pk>/projects/', ProjectListByStack.as_view(),
         name='project-list-by-stack'),
    path('project-media/', ProjectMediaList.as_view(), name='project-media-list'),
    path('project-media/<int:pk>/', ProjectMediaDetail.as_view(),
